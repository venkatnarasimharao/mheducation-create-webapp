...
export class ApiService {
  ...
  getProjectData(userId: string, projectId: string): Observable<any> {
    ...
    return this.apiMethodService({
      url: `/p/users/1000507376/projects/2341f3c1-19bd-9a1a-9f44-c15e6469ed93;jsessionid=qIFo6UkFY--hLSNF-uc0-ftaiwkw86lPJD6RXzjSbY23HXcnlLmn!-1589815393!1736926906629?nocacheTimestamp=1736926912133`,
      options: {
        // headers: headers,
      },
      method: 'GET',

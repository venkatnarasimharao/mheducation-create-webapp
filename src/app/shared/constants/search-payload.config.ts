export const USER_SEARCH_CONFIG = {
  search: {
    ...
    textNamespace: '',
    textConstraints: {
      textConstraint: ['-globalEdition:true', '-rightsRevoked:true'],
    },
    sortfield: {
      _name: 'Relevance',
      _id: '',
...
export const COLLECTION_CODES = [
  {
    code: 'mlp_logo_1',
    name: 'MACNEIL LEHRER Production',
    image: 'assets/images_wide/mlp_logo.png',
    category: 'Media',
  },
  {
    code: 'US_HIS_1',
    name: 'AMERICAN HISTORY',
    image: 'assets/images_wide/SR_ivey.png',
    category: 'History',
  },
  {
    code: 'AP_LABS_1',
    name: 'A & P LABS',
    image: 'assets/images_wide/SR_aplabs.png',
    category: 'Science',
  },
  {
    code: 'CN_COLL_1',
    name: 'CANADIAN CASE COLLECTION',
    image: 'assets/images_wide/SR_cancase.png',
    category: 'Business',
  },
  {
    code: 'DR_PUB_1',
    name: 'DARDEN BUSINESS',
    image: 'assets/images_wide/SR_darden.png',
    category: 'Business',
  },
  {
    code: 'CS_COLL_1',
    name: 'CASE CENTER COLLECTIONS',
    image: 'assets/images_wide/SR_ecch.png',
    category: 'Business',
  },
  {
    code: 'US_HIS_2',
    name: 'AMERICAN HISTORY',
    image: 'assets/images_wide/SR_american_his_doc.png',
    category: 'History',
  },
  {
    code: 'DR_PUB_2',
    name: 'DARDEN BUSINESS PUBLISHING',
    image: 'assets/images_wide/SR_darden.png',
    category: 'Business',
  },
  {
